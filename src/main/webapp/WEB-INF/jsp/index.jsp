	...
	<nav class="navbar navbar-expand-sm navbar-dark bg-primary rounded">
		...
		<ul class="navbar-nav ml-auto">
			<form class="form-inline">
				...
				<a style="color:white" href="<%=response.encodeUrl(request.getContextPath() + "/login")%>">Login</a>
			</form>
		</ul>
	</nav>
      ...
      <div class="row">
        <div class="col-lg-2 col-md-12 mb-4 mb-md-0">
          <div
            ...
            data-ripple-color="ligh" >
            <img src="<c:url value="/images/cualo2.png"/>" class="w-100" />
            <a href="#!">
        ...
        <div class="col-lg-2 col-md-12 mb-4 mb-md-0">
          <div
            ...
            <img src="<c:url value="/images/vinh.png" />" class="w-100" />
            <a href="#!">
        ...
        <div class="col-lg-2 col-md-12 mb-4 mb-md-0">
          <div
            class="bg-image hover-overlay ripple shadow-1-strong rounded"
            data-ripple-color="light" >
            <img src="images/langsen2.png" class="w-100" />
            <a href="#!">
              <div class="mask" style="background-color: rgba(251, 251, 251, 0.2);">
              </div>
            </a>
        ...
        <div class="col-lg-2 col-md-12 mb-4 mb-md-0">
          <div
            class="bg-image hover-overlay ripple shadow-1-strong rounded"
            data-ripple-color="light">
            <img src="images/congthanh.png" class="w-100" />
            <a href="#!">
              <div class="mask" style="background-color: rgba(251, 251, 251, 0.2);">
              </div>
            </a>
        ...
        <div class="col-lg-2 col-md-12 mb-4 mb-md-0">
          <div
            class="bg-image hover-overlay ripple shadow-1-strong rounded"
            data-ripple-color="light" >
            <img src="images/ditichPBC2.png" class="w-100" />
            <a href="#!">
              <div class="mask" style="background-color: rgba(251, 251, 251, 0.2);">
              </div>
            </a>
        ...
        <div class="col-lg-2 col-md-12 mb-4 mb-md-0">
          <div
            class="bg-image hover-overlay ripple shadow-1-strong rounded"
            data-ripple-color="light">
            <img src="images/mobahoangthiloan1.png" class="w-100"/>
            <a href="#!">
              <div class="mask" style="background-color: rgba(251, 251, 251, 0.2);">
			  </div>
            </a>
